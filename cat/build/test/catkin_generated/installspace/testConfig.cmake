...
if("FALSE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/iclab/Desktop/cat/src/test)
  set(test_DEVEL_PREFIX /home/iclab/Desktop/cat/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/iclab/Desktop/cat/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/iclab/Desktop/cat/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/iclab/Desktop/cat/install/lib;/home/iclab/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
